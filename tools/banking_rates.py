...
FALLBACK_AVANTAGES = [
    ...
    {"nom": "Royal Caribbean",  "ticker": "RCL",   "pays": "🇺🇸", "condition": "≥ 100 actions",          "avantage": "$100–$250 de crédit à bord par croisière réservée (toutes compagnies du groupe)", "lien": "https://www.boursorama.com/cours/1rDRCL/"},
    ...
    {"nom": "Oriental Land",    "ticker": "4661",  "pays": "🇯🇵", "condition": "100 actions",            "avantage": "1 billet d'entrée Disneyland Tokyo ou DisneySea par an (yutai)",                  "lien": "https://finance.yahoo.com/quote/4661.T/"},
