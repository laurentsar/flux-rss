...
def main():
    ...
    data = {"generated": now_str, "livrets": None, "primes": None, "primes_epargne": None, "livrets_boostes": None, "top_actions": None, "brokers": None, "avantages_actionnaires": None, "note": ""}
